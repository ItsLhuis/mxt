...
CREATE TABLE IF NOT EXISTS repairs (
    ...
    entry_accessories_description MEDIUMTEXT,
    entry_reported_issues_description MEDIUMTEXT,
    entry_description MEDIUMTEXT,
    entry_datetime TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    intervention_works_done_description MEDIUMTEXT,
    intervention_accessories_used_description MEDIUMTEXT,
    intervention_description MEDIUMTEXT,
