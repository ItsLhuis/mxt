...
const RepairDelivery = forwardRef(({ repairData, companyData, isFinished }, ref) => {
    ...
    <PrintLayout
      ...
      body={
        ...
        >
          ...
          <div style={{ width: "100%", padding: "32px 0", pageBreakInside: "avoid" }}>
            <div
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              <p className="label-signature">
                Declaro que recebi o equipamento e todos os acessórios
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <p className="label-signature label-main">Assinatura</p>
              </div>
            </div>
          </div>
        </main>
